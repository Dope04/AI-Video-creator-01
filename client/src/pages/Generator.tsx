        ...
        <div className="flex gap-20 max-sm:flex-col items-start justify-between ">
            ...
            <div className="w-full">
               ...
               <div className="mb-4 text-gray-300">
                ...
                <input type="text" id="productName" value={productName} onChange={(e)=>setProductName(e.target.value)} placeholder="Enter the product name" required
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all" />
               </div>
                <div className="mb-4 text-gray-300">
                <label htmlFor="productDescription" className="block test-sm mb-4">
                  Product Description
                ...
                placeholder="Describe the product in brief" className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 
                focus:border-violet-500/50 outline-none transition-all resize-none" />
               
                <div className="mb-4 text-gray-300">
                <label htmlFor="userprompt" className="block test-sm mb-4">
                  User Prompt
                  <span className="text-xs text-violet-400">
                    (Optional)
                  </span>
                ...
                placeholder="Describe how you want the video to be generated" className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 
                focus:border-violet-500/50 outline-none transition-all resize-none" />
                </div>
                <div className="mb-4 text-gray-300">
