            ...
            <div className="container mx-auto max-w-3xl">
                <div className="rounded-3xl bg-linear-to-b from-violet-900/20 to-violet-900/5 border border-violet-500/20 p-12 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        >
                            Ready to elevate your marketing with AI-generated videos?
                        </motion.h2>
                        ...
                        >
                            Start creating stunning marketing videos in minutes and watch your brand soar to new heights.
                        </motion.p>
                        <motion.div
                            initial={{ y: 60, opacity: 0 }}
                            whileInView={{ y: 0, opacity: 1 }}
                        ...
                        >
                            <GhostButton className="px-8 py-3 gap-2">
                                Start Now <ArrowRightIcon size={20} />
                            </GhostButton>
                        </motion.div>
                    </div>
                </div>
