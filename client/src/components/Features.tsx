    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Building blocks for your next big ideas"
                    description="Our AI instantly transforms your product images into engaging marketing content, saving you time and effort."
                />
